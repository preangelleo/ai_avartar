...
do
    # 检查 folder_name 是否是 '/Users/lgg/Downloads/Create_AI_Avatar/Users_Archive/cab', 如果不是则跳过
    if [ "$folder_name" != "/Users/lgg/Downloads/Create_AI_Avatar/Users_Archive/cab" ]; then
        continue
    fi
    ...
    rsync -avz --exclude=".DS_Store" --exclude="__pycache__" --exclude="test_inlocal.py" --exclude="files/audio/clone_voice" --exclude="files/bing_search" --exclude=".chroma/" "$source_dir" "$folder_name"
    ...
    rsync -avz --exclude=".DS_Store" --exclude="__pycache__" --exclude="test_inlocal.py" --exclude="files/audio/clone_voice" --exclude="files/bing_search" --exclude=".chroma/" "$folder_name/tg" root@3.112.201.254:/root/
