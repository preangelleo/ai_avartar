...
if __name__ == '__main__':
    ...
    print(f"\nSTEP 2: 更新 Bot Owner 的系统参数 ...")
    initialize_owner_parameters_table()

    print(f"\nSTEP 3: 读取并打印出 Bot Owner 的系统参数 ...")
    ...
    print(f"\nSTEP 4: 将 System Prompt 写入数据库表单 ...")
    insert_system_prompt_from_file(file_path='files/system_prompt.txt')

    print(f"\nSTEP 5: 读取并打印出 System Prompt ...")
    system_prompt = get_system_prompt()
    print(f"System Prompt: \n\n{system_prompt}")

    print(f"\nSTEP 6: 将 Dialogue Tone 写入数据库表单 ...")
    # 清空 avatar_dialogue_tone 表
    with Session() as session: 
