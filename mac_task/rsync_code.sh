...
do
    ...
    rsync -avz --exclude=".DS_Store" --exclude=".env" --exclude="__pycache__" --exclude="test_inlocal.py" --exclude="files/audio/clone_voice" --exclude="files/bing_search" "$source_dir" "$folder_name"
    ...
    rsync -avz --exclude=".DS_Store" --exclude="__pycache__" --exclude="test_inlocal.py" --exclude="files/audio/clone_voice" --exclude="files/bing_search" "$folder_name/tg" root@$(cat "$folder_name/configuration.json" | jq -r '.UBUNTU_SERVER_IP_ADDRESS'):/root/
